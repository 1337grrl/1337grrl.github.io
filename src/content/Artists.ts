...
export const ourArtists: ArtistType[] = [
    ...
    },
    {
        ...
        'Deutsche Stimme von Helen Hunt, Kim Basinger, Emily Watson, Cate Blachet.\nHauptrollen in AVATAR, Star Trek, Marvel Avengers\n\n'+
        'Beim Musikfest Wannsee ist sie als Erzählerin in “Die schöne Magelone” zu erleben. ',
    },
    {
    ...
    },
    {
        ...
        description: 'Dozent für Repertoire und Liedgestaltung an der Universität der Künste Berlin.\nSolorepetitor an den Staatsopern Hannover und Stuttgart sowie an der Komischen Oper Berlin.\n'+
        'Pianistische Tätigkeit: Konzerte mit Chören und Orchestern, wie z.B. dem RIAS Kammerchor oder der Kammerakademie Potsdam, Kammermusik, Uraufführungen sowie Rundfunk- und CD-Produktionen. Konzerte und Liederabende mit Sängern wie u.a. Ute Lemper, Gisela May, Dagmar Schellenberger, Julie Kaufmann, Sunhae Im.\n\n'+
        'Beim Musikfest Wannsee in “Die schöne Magelone” von J. Brahms zu erleben.',
    },
    {
        name: 'Eleonora Trivella | Oboistin',
        image: 'Artists/Eleonora_Trivella_Oboe.png',
        description: 'Abschluss Master Barockoboe in der Klasse von Xenia Löffler, musiziert regelmäßig mit renommierten Ensembles wie u.a. der Akademie für Alte Musik und Collegium 1704\n'+
        'Seit WS 2023/24 Lehrauftrag für Barockoboen-Technik und Quellenkunde an der Universität der Künste Berlin',
    },
    {
        name: 'Enrico Toffano | Barock-Fagottist',
        image: 'Artists/EnricoToffano_Fagott.png',
        description: 'Ausbildung: in der Fagott-Klasse von Prof. Gustavo Nunez an der HfM Düsseldorf, Spezialisierung auf historische Aufführungspraxis an der Universität der Künste Berlin in der Klasse von Christian Beuse.\n'+
        'Rege Konzerttätigkeit mit renommierten Ensembles, Mitbegründer des international tätigen Fagotttrios “L’Eléphant bleu”',
    },
    {
        name: 'Mimoe Todo | Cembalistin',
        image: 'Artists/Mimoe_Todo.png',
        description: 'Cembalistin aus Japan mit umfangreicher Konzerttätigkeit im Ensemble und als Continuo-Spielerin\n'+
        'Preisträgerin beim Internationalen Berliner Bach-Wettbewerb\Vertiefungskurs an der Universität der Künste Berlin\n'+
        'Seit 2023 Korrepetitorin für Alte Musik an der HfK Bremen',
    },
    {
        name: 'Johanna Kaldewei | Sopranistin',
        image: 'Artists/Johanna_Portrait.png',
        description: 'Rege internationale Konzerttätigkeit als Konzert-, Lied und Opernsängerin\n'+ 
        'Preisträgerin mehrerer internationaler Wettbewerbe, u.a. Telemann-Preis, Gewinnerin des Podiums Junger Gesangssolisten, “Sonderpreis für die schönste Sopranstimme“ beim Giulio-Perotti-Wettbewerb\n'+
